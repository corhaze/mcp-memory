...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "(2) semantic_search_* with a focused query — this is the preferred way to find "
        ...
        "targeted semantic_search_* or search query instead. list_* tools are only "
        ...
        "about the project, always search the memory bank first. Run a semantic_search_* "
